          ...
          <div className="mx-auto max-w-7xl">
            <div className="text-center">
              ...
              <h1 className="mx-auto max-w-4xl text-5xl font-extrabold tracking-tight text-zinc-900 sm:text-7xl">
                ...
                <span className="text-indigo-600">guided AI counsellor.</span>
              </h1>
              <p className="mx-auto mt-8 max-w-2xl text-lg leading-8 text-zinc-600 sm:text-xl">
                Get personalized university recommendations, track your
                applications, and receive AI-guided support throughout your
              ...
              <div className="mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row">
                <Button
                  size="lg"
                  asChild
                  className="h-14 bg-indigo-600 px-8 text-lg hover:bg-indigo-700 shadow-xl shadow-indigo-200"
                >
                ...
                <Button
                  ...
                  variant="outline"
                  asChild
                  className="h-14 border-zinc-200 px-8 text-lg hover:bg-zinc-50"
                >
                ...
                <div className="grid grid-cols-1 gap-12 lg:grid-cols-3">
                  <div className="flex flex-col items-start text-left">
                    ...
                    <p className="mt-2 text-zinc-600 leading-relaxed">
                      Access top universities across USA, UK, Canada, Australia,
                      and Europe with localized insights.
                    </p>
                  </div>
                  <div className="flex flex-col items-start text-left">
                    <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-indigo-50 text-indigo-600">
                    ...
                    <p className="mt-2 text-zinc-600 leading-relaxed">
                      Our advanced AI model analyzes your profile to suggest
                      safe, target, and dream universities.
                    </p>
                  </div>
                  <div className="flex flex-col items-start text-left">
                    <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-indigo-50 text-indigo-600">
                    ...
                    <p className="mt-2 text-zinc-600 leading-relaxed">
                      Never miss a deadline. Manage tasks, SOPs, and document
                      readiness in one central dashboard.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h2 className="text-3xl font-bold tracking-tight text-zinc-900 sm:text-4xl">
                A Guided, Stage-Based Experience
              </h2>
              <p className="mx-auto mt-4 max-w-2xl text-lg text-zinc-600">
                We break down the overwhelming study-abroad process into clear,
                actionable stages.
              </p>
            </div>
            ...
            <div className="mt-20 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                <div
                  key={idx}
                  className="relative flex flex-col items-center rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm transition-transform hover:-translate-y-1"
                >
